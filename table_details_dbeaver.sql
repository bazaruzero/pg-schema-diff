...
select
    'check_date,db_host,table_schema,table_name,table_columns_hash,table_options_hash,table_indexes_hash,table_triggers_hash,table_partitions_hash' as csv_line
union all
select
    '"' || check_date || '","' || db_host || '","' ||
    table_schema || '","' ||
